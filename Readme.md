...
1. Используется исходный код [с лабораторной работы, посвященной работе с данными с помощью интерфейса PDO или MySQLi](https://gitlab.com/php576/pdo-var0). Проверить его работу.
...
Данные подгружаются на клиент с помощью класса XMLHttpRequest без перегрузки. Благодаря технологии AJAX веб-приложение получилось одностраничным.
